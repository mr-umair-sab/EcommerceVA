      ...
      <div class="container mx-auto px-4 md:px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div class="order-2 md:order-1 space-y-6">
            ...
            <div class="pt-6 grid grid-cols-2 gap-6">
              <div class="bg-amber-50 p-6 rounded-2xl border border-amber-100">
                <h4 class="text-4xl font-extrabold text-amber-600 mb-2">
                  4+
                </h4>
              ...
              <div class="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                <h4 class="text-4xl font-extrabold text-blue-600 mb-2">
                  24/7
                </h4>
                <p class="text-gray-700 font-medium">
                  Support & Monitoring
          ...
          <div class="order-1 md:order-2 relative">
            ...
            <!-- Experience badge -->
            <div class="absolute -bottom-8 -left-8 bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
